import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-0dc074eb.js';
 ...
 * Copyright (c) Microblink Ltd. All rights reserved.
 */
const defaultWasmModuleName = "BlinkCardWasmSDK";
...
(function (AnonymizationMode) {
    ...
    AnonymizationMode[AnonymizationMode["Count"] = 4] = "Count";
...
class CardNumberAnonymizationSettings {
    constructor() {
        ...
        this.mode = AnonymizationMode.ImageOnly;
...
class BlinkCardRecognizerSettings {
    constructor() {
        ...
        this.anonymizationSettings = new AnonymizationSettings();
        /**
        ...
        this.returnFullDocumentImage = true;
 ...
 * @param wasmSDK Instance of WasmSDK which will be used to communicate with the WebAssembly module.
 */
function createBlinkCardRecognizer(wasmSDK) {
    return __awaiter(this, void 0, void 0, function* () {
        return wasmSDK.mbWasmModule.newRecognizer("BlinkCardRecognizer");
    });
}
/**
...
(function (CardIssuer) {
    /* Unidentified Card */
    CardIssuer[CardIssuer["Other"] = 0] = "Other";
    /* The American Express Company Card */
    CardIssuer[CardIssuer["AmericanExpress"] = 1] = "AmericanExpress";
    /* China UnionPay Card */
    CardIssuer[CardIssuer["ChinaUnionPay"] = 2] = "ChinaUnionPay";
    /* Diners Club International Card */
    CardIssuer[CardIssuer["Diners"] = 3] = "Diners";
    /* Discover Card */
    CardIssuer[CardIssuer["DiscoverCard"] = 4] = "DiscoverCard";
    /*  Elo card association */
    CardIssuer[CardIssuer["Elo"] = 5] = "Elo";
    /* The JCB Company Card */
    CardIssuer[CardIssuer["Jcb"] = 6] = "Jcb";
    /* Maestro Debit Card */
    CardIssuer[CardIssuer["Maestro"] = 7] = "Maestro";
    /* Mastercard Inc. Card */
    CardIssuer[CardIssuer["Mastercard"] = 8] = "Mastercard";
    /* RuPay */
    CardIssuer[CardIssuer["RuPay"] = 9] = "RuPay";
    /* Interswitch Verve Card */
    CardIssuer[CardIssuer["Verve"] = 10] = "Verve";
    /* Visa Inc. Card */
    CardIssuer[CardIssuer["Visa"] = 11] = "Visa";
    /* V Pay */
    CardIssuer[CardIssuer["VPay"] = 12] = "VPay";
    /* Enum count */
    CardIssuer[CardIssuer["Count"] = 13] = "Count";
...
(function (ProcessingStatus) {
    ...
    ProcessingStatus[ProcessingStatus["ImageReturnFailed"] = 6] = "ImageReturnFailed";
    /** Payment card currently not supported by the recognizer. */
    ProcessingStatus[ProcessingStatus["UnsupportedCard"] = 7] = "UnsupportedCard";
    /** Number of possible processing statuses. */
    ProcessingStatus[ProcessingStatus["Count"] = 8] = "Count";
})(ProcessingStatus || (ProcessingStatus = {}));

const BlinkCardSDK = /*#__PURE__*/Object.freeze({
  __proto__: null,
  get AnonymizationMode () { return AnonymizationMode; },
  AnonymizationSettings: AnonymizationSettings,
  BlinkCardRecognizerSettings: BlinkCardRecognizerSettings,
  CapturedFrame: CapturedFrame,
  get CardIssuer () { return CardIssuer; },
  ...
  createBlinkCardRecognizer: createBlinkCardRecognizer,
...
BlinkcardInBrowser.style = blinkcardInBrowserCss;
